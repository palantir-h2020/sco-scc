...
public class BillingSearchModelValidator implements ConstraintValidator<BillingSearchModel, SCBillingSLASearchDto> {
    @Override
    public boolean isValid(SCBillingSLASearchDto value, ConstraintValidatorContext context) {
